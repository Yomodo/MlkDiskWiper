// Generated with: mgmtclassgen Win32_Volume /P MlkDiskWiper\WMI\Volume.cs
...
namespace ROOT.CIMV2.Win32 {
    ...
    // An Early Bound class generated for the WMI class.Win32_Volume
    public class Volume : System.ComponentModel.Component {
        ...
        public bool IsIndexingEnabledNull {
            get {
                if ((curObj["IndexingEnabled"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        public bool IsMaximumFileNameLengthNull {
            get {
                if ((curObj["MaximumFileNameLength"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        public bool IsPageFilePresentNull {
            get {
                if ((curObj["PageFilePresent"] == null)) {
                    return true;
                }
                else {
                    return false;
